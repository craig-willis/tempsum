 ...
 */
public class MultiFileThriftDumper extends TSBase implements Tool {
    private static final Logger logger = Logger.getLogger(MultiFileThriftDumper.class);
    ...
    public int run(String[] args) throws Exception
    {
        ...
        job.setJarByClass(MultiFileThriftDumper.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new MultiFileThriftDumper(), args);
        System.exit(res);
    }
}
