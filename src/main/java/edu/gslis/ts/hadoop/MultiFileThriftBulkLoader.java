...
import edu.gslis.streamcorpus.MultiFileThriftFileInputFormat;
 ...
 * top-scoring query.
 */
public class MultiFileThriftBulkLoader extends TSBase implements Tool 
{
    private static final Logger logger = Logger.getLogger(MultiFileThriftBulkLoader.class);
    ...
    public int run(String[] args) throws Exception
    {
        ...
        job.setJarByClass(MultiFileThriftBulkLoader.class);       
        job.setJobName("Bulk Loading HBase Table::"+ tableName);        
        job.setInputFormatClass(MultiFileThriftFileInputFormat.class);     
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new MultiFileThriftBulkLoader(), args);
        System.exit(res);
    }
}
