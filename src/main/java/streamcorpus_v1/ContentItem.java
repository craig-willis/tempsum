...
;
  ...
  public int compareTo(ContentItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetCleansed()).compareTo(other.isSetCleansed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCleansed()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cleansed, other.cleansed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
